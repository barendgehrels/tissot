#ifndef TISSOT_CONVERTER_AEA_HPP
#define TISSOT_CONVERTER_AEA_HPP
...
class converter_cpp_bg_aea : public converter_cpp_bg_default
{
    public :
        converter_cpp_bg_aea(projection_properties& prop)
            : m_prop(prop)
        {
        }
...
#endif // TISSOT_CONVERTER_AEA_HPP
