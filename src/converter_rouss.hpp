#ifndef TISSOT_CONVERTER_ROUSS_HPP
#define TISSOT_CONVERTER_ROUSS_HPP
...
class converter_cpp_bg_rouss : public converter_cpp_bg_default
{
    public :
        converter_cpp_bg_rouss(projection_properties& prop)
            : m_prop(prop)
        {
        }
        ...
        void convert()
        {
            ...
            {
                 boost::replace_all(line, "void *en;", "MDIST en;");
            }
        }
...
#endif // TISSOT_CONVERTER_ROUSS_HPP
